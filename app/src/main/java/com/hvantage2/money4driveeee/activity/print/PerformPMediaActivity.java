...
public class PerformPMediaActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "PerformPMediaActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setRecycler_view();
        tvProjectTittle.setText(AppPreference.getSelectedPMediaName(PerformPMediaActivity.this));
    }
    ...
    private void setRecycler_view() {
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(PerformPMediaActivity.this);
        recycler_view.setLayoutManager(layoutManager);
        adapter = new ActivityAdapter(PerformPMediaActivity.this, activityList);
        recycler_view.setAdapter(adapter);
        recycler_view.addOnItemTouchListener(new RecyclerItemClickListener(PerformPMediaActivity.this, recycler_view, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {

                ShopActivity model = activityList.get(position);
                if (activityList.get(position).getActivity_status() == 1) {
                    Intent intent = new Intent(PerformPMediaActivity.this, SingleActivityDetail.class);
                    ...
                    Intent intent = new Intent(PerformPMediaActivity.this, UploadPhotosActivity.class);
                    intent.setAction("print");
                    intent.putExtra("media_option_id", model.getActivity_id());
                    intent.putExtra("media_option_name", model.getActivity_name());
                    startActivity(intent);
    ...
    private void init() {
        ...
        ((CustomTextView) findViewById(R.id.tvTitle)).setText("Newspaper/Magazine");
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.imagViewEdit) {
            Intent intent = new Intent(PerformPMediaActivity.this, MediaDetailActivity.class);
    ...
    class GetActivityTask extends AsyncTask<Void, String, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            jsonObject.addProperty("user_id", AppPreference.getUserId(PerformPMediaActivity.this));
            jsonObject.addProperty("project_id", AppPreference.getSelectedProjectId(PerformPMediaActivity.this));
            jsonObject.addProperty("print_id", AppPreference.getSelectedPMediaId(PerformPMediaActivity.this));
        ...
        protected void onProgressUpdate(String... values) {
            ...
            if (status.equalsIgnoreCase("400")) {
                Toast.makeText(PerformPMediaActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        }
    }
}
