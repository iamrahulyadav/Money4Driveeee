...
public class SelectEMediaOptionActivity extends AppCompatActivity {
    ...
    private void setRecyclerView() {
        ...
        LinearLayoutManager manager = new LinearLayoutManager(SelectEMediaOptionActivity.this);
        recycler_view.setLayoutManager(manager);
        adapter = new MediaAdapter(SelectEMediaOptionActivity.this, list);
        recycler_view.setAdapter(adapter);
        recycler_view.addOnItemTouchListener(new RecyclerItemClickListener(SelectEMediaOptionActivity.this, recycler_view, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(SelectEMediaOptionActivity.this, SelectEMediaActivity.class);
    ...
    public class GetData extends AsyncTask<Void, String, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            jsonObject.addProperty("user_id", AppPreference.getUserId(SelectEMediaOptionActivity.this)); //8
            jsonObject.addProperty("project_id", AppPreference.getSelectedProjectId(SelectEMediaOptionActivity.this));
            jsonObject.addProperty("branding_id", AppPreference.getSelectedAlloMediaId(SelectEMediaOptionActivity.this));
            jsonObject.addProperty("media_type_id", media_type_id);
            Log.e(TAG, "Request EMEDIA MEDIA_OPTIONS >> " + jsonObject);
            ...
            call.enqueue(new Callback<JsonObject>() {
                ...
                public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                    Log.e(TAG, "Response EMEDIA MEDIA_OPTIONS >> " + response.body().toString());
        ...
        protected void onProgressUpdate(String... values) {
            ...
            if (status.equalsIgnoreCase("200")) {
                ...
                Toast.makeText(SelectEMediaOptionActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        }
    }
