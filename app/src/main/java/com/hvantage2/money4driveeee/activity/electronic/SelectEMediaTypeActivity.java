...
public class SelectEMediaTypeActivity extends AppCompatActivity {

    private static final String TAG = "SelectEMediaType";
    ...
    private void setRecyclerView() {
        ...
        LinearLayoutManager manager = new LinearLayoutManager(SelectEMediaTypeActivity.this);
        recycler_view.setLayoutManager(manager);
        adapter = new MediaAdapter(SelectEMediaTypeActivity.this, list);
        recycler_view.setAdapter(adapter);
        recycler_view.addOnItemTouchListener(new RecyclerItemClickListener(SelectEMediaTypeActivity.this, recycler_view, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(SelectEMediaTypeActivity.this, SelectEMediaOptionActivity.class);
                intent.putExtra("media_type_id", list.get(position).getMedia_id());
                intent.putExtra("media_type_name", list.get(position).getMedia_name());
    ...
    public class GetData extends AsyncTask<Void, String, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            jsonObject.addProperty("user_id", AppPreference.getUserId(SelectEMediaTypeActivity.this));
            jsonObject.addProperty("project_id", AppPreference.getSelectedProjectId(SelectEMediaTypeActivity.this));
            jsonObject.addProperty("branding_id", AppPreference.getSelectedAlloMediaId(SelectEMediaTypeActivity.this));
            Log.e(TAG, "Request EMEDIA MEDIA_TYPE >> " + jsonObject);
            ...
            call.enqueue(new Callback<JsonObject>() {
                ...
                public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                    Log.e(TAG, "Response EMEDIA MEDIA_TYPE >> " + response.body().toString());
        ...
        protected void onProgressUpdate(String... values) {
            ...
            if (status.equalsIgnoreCase("200")) {
                ...
                Toast.makeText(SelectEMediaTypeActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        }
    }
