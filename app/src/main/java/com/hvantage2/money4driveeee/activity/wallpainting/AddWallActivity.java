...
public class AddWallActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private CustomEditText etWallName, etContName, etContNo, etState, etCity, etAddress, etStartDate, etEndDate;
    ...
    private void init() {
        etWallName = (CustomEditText) findViewById(R.id.etWallName);
