...
public class PerformShopActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setRecycler_view();
        tvProjectTittle.setText(AppPreference.getSelectedShopName(PerformShopActivity.this));
    }
    ...
    private void setRecycler_view() {
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(PerformShopActivity.this);
        recycler_view.setLayoutManager(layoutManager);
        adapter = new ActivityAdapter(PerformShopActivity.this, activityList);
        recycler_view.setAdapter(adapter);
        recycler_view.addOnItemTouchListener(new RecyclerItemClickListener(PerformShopActivity.this, recycler_view, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {

                ShopActivity model = activityList.get(position);
                Intent intent = new Intent(PerformShopActivity.this, SingleActivityDetail.class);
                ...
                /*if (activityList.get(position).getActivity_status() == 1) {
                    ...
                    Intent intent = new Intent(PerformShopActivity.this, UploadPhotosActivity.class);
                    intent.setAction("shop");
                    intent.putExtra("media_option_id", model.getActivity_id());
                    intent.putExtra("media_option_name", model.getActivity_name());
                    startActivity(intent);
    ...
    class GetActivityTask extends AsyncTask<Void, String, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            jsonObject.addProperty("user_id", AppPreference.getUserId(PerformShopActivity.this));
            jsonObject.addProperty("project_id", AppPreference.getSelectedProjectId(PerformShopActivity.this));
            jsonObject.addProperty("shop_id", AppPreference.getSelectedShopid(PerformShopActivity.this));
        ...
        protected void onProgressUpdate(String... values) {
            ...
            if (status.equalsIgnoreCase("400")) {
                Toast.makeText(PerformShopActivity.this, msg, Toast.LENGTH_SHORT).show();
