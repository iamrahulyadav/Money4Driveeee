...
public class SelectWallActivity extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "SelectWallActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Select Wall");
        init();
    ...
    private void setTransitListRecyclerView() {
        ...
        LinearLayoutManager manager = new LinearLayoutManager(SelectWallActivity.this);
        recycler_view_reg_no.setLayoutManager(manager);
        adapter = new SourceAdapter(SelectWallActivity.this, list);
        recycler_view_reg_no.setAdapter(adapter);
        recycler_view_reg_no.addOnItemTouchListener(new RecyclerItemClickListener(SelectWallActivity.this, recycler_view_reg_no, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                AppPreference.setSelectedWallId(SelectWallActivity.this, list.get(position).getId());
                AppPreference.setSelectedWallName(SelectWallActivity.this, list.get(position).getName());
                if (list.get(position).getStatus().equalsIgnoreCase("1")) {
                    Intent intent = new Intent(SelectWallActivity.this, PerformWallActivity.class);
                    intent.putExtra("media_option_id", media_option_id);
                    startActivity(intent);
                } else {
                    Intent intent1 = new Intent(SelectWallActivity.this, WallDetailActivity.class);
    ...
    public class getTransitList extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... strings) {
            ...
            jsonObject.addProperty("method", AppConstants.FEILDEXECUTATIVE.PROJECTWALLLIST);
            jsonObject.addProperty("user_id", AppPreference.getUserId(SelectWallActivity.this));
            jsonObject.addProperty("project_id", AppPreference.getSelectedProjectId(SelectWallActivity.this));
            jsonObject.addProperty("media_option_id", media_option_id);
            Log.e(TAG, "Request GET WALLS >> " + jsonObject.toString());
            ...
            call.enqueue(new Callback<JsonObject>() {
                ...
                public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                    Log.e(TAG, "Response GET WALLS >>" + response.body().toString());
                    ...
                    try {
                        ...
                        if (jsonObject.getString("status").equalsIgnoreCase("200")) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                model.setId(object.getString("wall_id"));
                                model.setName(object.getString("wall_name"));
        ...
        protected void onProgressUpdate(String... values) {
            ...
            if (status.equalsIgnoreCase("400")) {
                ...
                list.clear();
                adapter.notifyDataSetChanged();
                Toast.makeText(SelectWallActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        }
    }
}
