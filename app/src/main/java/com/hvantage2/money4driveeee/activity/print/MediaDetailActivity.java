...
public class MediaDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pmedia_id = AppPreference.getSelectedPMediaId(MediaDetailActivity.this);
        project_id = AppPreference.getSelectedProjectId(MediaDetailActivity.this);
...
//        listState.add(new Gson().fromJson("{\"id\":\"0\",\"name\":\"Select state\"}", StateCityModel.class));
        ...
        spinnerState.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                new MediaDetailActivity.GetCityTask().execute();
...
//        listCity.add(new Gson().fromJson("{\"id\":\"0\",\"name\":\"Select city\"}", StateCityModel.class));
    ...
    private class GetStateTask extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... strings) {
            ...
            jsonObject.addProperty("project_id", AppPreference.getSelectedProjectId(MediaDetailActivity.this));
    ...
    public class getDetailTask extends AsyncTask<Void, String, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            JsonObject jsonObject = new JsonObject();
            jsonObject.addProperty("method", AppConstants.FEILDEXECUTATIVE.PROJECTSPRINTMEDIADETAILS);
            ...
            jsonObject.addProperty("print_id", pmedia_id);
    ...
    public class updateDetailTask extends AsyncTask<Void, String, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            JsonObject jsonObject = new JsonObject();
            jsonObject.addProperty("method", AppConstants.FEILDEXECUTATIVE.SAVEMEDIADETAIL);
            jsonObject.addProperty("user_id", AppPreference.getUserId(MediaDetailActivity.this)); //8
            jsonObject.addProperty("project_id", project_id);
        ...
        protected void onProgressUpdate(String... values) {
            ...
            String msg = values[1];
            if (status.equalsIgnoreCase("200")) {
                Intent intent = new Intent(MediaDetailActivity.this, PerformPMediaActivity.class);
