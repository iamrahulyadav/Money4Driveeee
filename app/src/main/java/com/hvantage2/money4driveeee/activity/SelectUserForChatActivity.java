...
import com.hvantage2.money4driveeee.adapter.SelectUserAdapter;
...
public class SelectUserForChatActivity extends AppCompatActivity {

    private static final String TAG = "SelectUserFChat";
    private RecyclerView recyclerView;
    private TextView tvEmpty;
    private ArrayList<UserModal> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        list = new ArrayList<UserModal>();

        UserModal data1 = new UserModal();
        data1.setUserId("1");
        data1.setName("Ashu Khare");
        UserModal data2 = new UserModal();
        data2.setUserId("1");
        data2.setName("RK");
        UserModal data3 = new UserModal();
        data3.setUserId("1");
        data3.setName("Ashutosh");
        UserModal data4 = new UserModal();
        data4.setUserId("1");
        data4.setName("Raj Kumar");
        list.add(data1);
        list.add(data2);
        list.add(data3);
        list.add(data4);
    ...
    private void setAdapter() {
        ...
        adapter = new SelectUserAdapter(this, list);
        recyclerView.setAdapter(adapter);
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(SelectUserForChatActivity.this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
               /* Intent intent = new Intent(SelectUserForChatActivity.this, ChatActivity.class);
    ...
    public class getAllProjectTask extends AsyncTask<Void, String, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            jsonObject.addProperty("user_id", AppPreference.getUserId(SelectUserForChatActivity.this)); //8
            jsonObject.addProperty("user_type", AppPreference.getUserTypeId(SelectUserForChatActivity.this));
                    ...
                    try {
                        ...
                        if (jsonObject.getString("status").equalsIgnoreCase("200")) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                UserModal model = new Gson().fromJson(jsonObject1.toString(), UserModal.class);
