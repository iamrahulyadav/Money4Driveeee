...
public class SelectShopActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setRecyclerView() {
        ...
        LinearLayoutManager manager = new LinearLayoutManager(SelectShopActivity.this);
        recycler_view.setLayoutManager(manager);
        adapter = new SourceAdapter(SelectShopActivity.this, list);
        ...
        recycler_view.addOnItemTouchListener(new RecyclerItemClickListener(this, recycler_view, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                if (list.get(position).getStatus().equalsIgnoreCase("1")) {
                    Intent intent = new Intent(SelectShopActivity.this, PerformShopActivity.class);
                    intent.putExtra("media_option_id", media_option_id);
    ...
    public class GetShopList extends AsyncTask<Void, String, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            jsonObject.addProperty("method", AppConstants.FEILDEXECUTATIVE.PROJECTSHOPLISTS);
            jsonObject.addProperty("user_id", AppPreference.getUserId(SelectShopActivity.this)); //8
            jsonObject.addProperty("project_id", AppPreference.getSelectedProjectId(SelectShopActivity.this));
            jsonObject.addProperty("media_option_id", media_option_id);
            Log.e(TAG, "Request GET SHOP LIST >> " + jsonObject);
            ...
            call.enqueue(new Callback<JsonObject>() {
                ...
                public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                    Log.e(TAG, "Response GET SHOP LIST >> " + response.body().toString());
                    ...
                    try {
                        ...
                        if (jsonObject1.getString("status").equalsIgnoreCase("200")) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                model.setId(jsonObject11.getString("shop_id"));
                                model.setName(jsonObject11.getString("shop_name"));
