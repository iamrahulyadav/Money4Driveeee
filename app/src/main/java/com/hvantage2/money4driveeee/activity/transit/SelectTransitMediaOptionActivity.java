...
public class SelectTransitMediaOptionActivity extends AppCompatActivity {

    private static final String TAG = "SelTransitMediaOption";
    ...
    private void setRecyclerView() {
        ...
        LinearLayoutManager manager = new LinearLayoutManager(SelectTransitMediaOptionActivity.this);
        recycler_view.setLayoutManager(manager);
        adapter = new MediaAdapter(SelectTransitMediaOptionActivity.this, list);
        recycler_view.setAdapter(adapter);
        recycler_view.addOnItemTouchListener(new RecyclerItemClickListener(SelectTransitMediaOptionActivity.this, recycler_view, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(SelectTransitMediaOptionActivity.this, SelectVehicleActivity.class);
    ...
    public class GetData extends AsyncTask<Void, String, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            jsonObject.addProperty("user_id", AppPreference.getUserId(SelectTransitMediaOptionActivity.this)); //8
            jsonObject.addProperty("project_id", AppPreference.getSelectedProjectId(SelectTransitMediaOptionActivity.this));
            jsonObject.addProperty("branding_id", AppPreference.getSelectedAlloMediaId(SelectTransitMediaOptionActivity.this));
            jsonObject.addProperty("media_type_id", media_type_id);
            Log.e(TAG, "Request TRANSIT MEDIA_OPTIONS >> " + jsonObject);
            ...
            call.enqueue(new Callback<JsonObject>() {
                ...
                public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                    Log.e(TAG, "Response TRANSIT MEDIA_OPTIONS >> " + response.body().toString());
                    ...
                    try {
                        ...
                        if (jsonObject1.getString("status").equalsIgnoreCase("200")) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                MediaModel model = new MediaModel(jsonObject11.getString("media_option_id"), jsonObject11.getString("media_option_name"));
                                list.add(model);
                            }
        ...
        protected void onProgressUpdate(String... values) {
            ...
            if (status.equalsIgnoreCase("200")) {
                ...
                Toast.makeText(SelectTransitMediaOptionActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        }
    }
