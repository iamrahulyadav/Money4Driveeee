                    ...
                    try {
                        ...
                        if (jsonObject.getString("status").equalsIgnoreCase("200")) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                tvProjectTittle.setText(object.getString("project_title"));
                                tvProjectDesc.setText(object.getString("project_desc"));
                                tvCreationDate.setText(object.getString("created_date"));
                                tvAllocationDate.setText(object.getString("allotted_date"));
