...
public class SelectShopMediaTypeActivity extends AppCompatActivity {
    ...
    private void setAdapter() {
        ...
        adapter = new MediaAdapter(SelectShopMediaTypeActivity.this, list);
        recycler_view.setAdapter(adapter);
        recycler_view.addOnItemTouchListener(new RecyclerItemClickListener(SelectShopMediaTypeActivity.this, recycler_view, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(SelectShopMediaTypeActivity.this, SelectShopMediaOptionActivity.class);
    ...
    public class GetData extends AsyncTask<Void, String, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            jsonObject.addProperty("user_id", AppPreference.getUserId(SelectShopMediaTypeActivity.this));
            jsonObject.addProperty("project_id", AppPreference.getSelectedProjectId(SelectShopMediaTypeActivity.this));
            jsonObject.addProperty("branding_id", AppPreference.getSelectedAlloMediaId(SelectShopMediaTypeActivity.this));
            Log.e(TAG, "Request SHOP MEDIA_TYPE >> " + jsonObject);
            ...
            call.enqueue(new Callback<JsonObject>() {
                ...
                public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                    Log.e(TAG, "Response SHOP MEDIA_TYPE >> " + response.body().toString());
