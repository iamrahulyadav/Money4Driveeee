...
public class PerformWallActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setRecycler_view();
        tvProjectTittle.setText(AppPreference.getSelectedWallName(PerformWallActivity.this));
    }
    ...
    private void setRecycler_view() {
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(PerformWallActivity.this);
        recycler_view.setLayoutManager(layoutManager);
        adapter = new ActivityAdapter(PerformWallActivity.this, activityList);
        recycler_view.setAdapter(adapter);
        recycler_view.addOnItemTouchListener(new RecyclerItemClickListener(PerformWallActivity.this, recycler_view, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                ...
                if (activityList.get(position).getActivity_status() == 1) {
                    ...
                    Intent intent = new Intent(PerformWallActivity.this, UploadPhotosActivity.class);
                    intent.setAction("wall");
                    intent.putExtra("media_option_id", model.getActivity_id());
                    intent.putExtra("media_option_name", model.getActivity_name());
                    startActivity(intent);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.imagViewEdit) {
            Intent intent = new Intent(PerformWallActivity.this, WallDetailActivity.class);
    ...
    class GetActivityTask extends AsyncTask<Void, String, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            jsonObject.addProperty("user_id", AppPreference.getUserId(PerformWallActivity.this));
            jsonObject.addProperty("project_id", AppPreference.getSelectedProjectId(PerformWallActivity.this));
            jsonObject.addProperty("wall_id", AppPreference.getSelectedWallId(PerformWallActivity.this));
        ...
        protected void onProgressUpdate(String... values) {
            ...
            if (status.equalsIgnoreCase("400")) {
                Toast.makeText(PerformWallActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        }
    }
