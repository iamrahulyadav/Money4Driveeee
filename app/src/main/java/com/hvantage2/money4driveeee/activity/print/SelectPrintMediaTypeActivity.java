...
public class SelectPrintMediaTypeActivity extends AppCompatActivity {

    private static final String TAG = "SelectShopMediaType";
    ...
    private void setRecyclerView() {
        ...
        LinearLayoutManager manager = new LinearLayoutManager(SelectPrintMediaTypeActivity.this);
        recycler_view.setLayoutManager(manager);
        adapter = new MediaAdapter(SelectPrintMediaTypeActivity.this, list);
        recycler_view.setAdapter(adapter);
        recycler_view.addOnItemTouchListener(new RecyclerItemClickListener(SelectPrintMediaTypeActivity.this, recycler_view, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(SelectPrintMediaTypeActivity.this, SelectPrintMediaOptionActivity.class);
    ...
    public class GetData extends AsyncTask<Void, String, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            jsonObject.addProperty("user_id", AppPreference.getUserId(SelectPrintMediaTypeActivity.this));
            jsonObject.addProperty("project_id", AppPreference.getSelectedProjectId(SelectPrintMediaTypeActivity.this));
            jsonObject.addProperty("branding_id", AppPreference.getSelectedAlloMediaId(SelectPrintMediaTypeActivity.this));
            Log.e(TAG, "Request PRINT MEDIA_TYPE >> " + jsonObject);
            ...
            call.enqueue(new Callback<JsonObject>() {
                ...
                public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                    Log.e(TAG, "Response PRINT MEDIA_TYPE >> " + response.body().toString());
        ...
        protected void onProgressUpdate(String... values) {
            ...
            if (status.equalsIgnoreCase("200")) {
                ...
                Toast.makeText(SelectPrintMediaTypeActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        }
    }
