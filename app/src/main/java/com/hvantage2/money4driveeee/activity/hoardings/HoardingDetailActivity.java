...
public class HoardingDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hoarding_id = AppPreference.getSelectedHoardingId(HoardingDetailActivity.this);
        project_id = AppPreference.getSelectedProjectId(HoardingDetailActivity.this);
        ...
        Log.e(TAG, "onCreate: hoarding_id >> " + hoarding_id);
        init();
...
//        listCity.add(new Gson().fromJson("{\"id\":\"0\",\"name\":\"Select city\"}", StateCityModel.class));
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.imgDoc1) {
            imgCounter = 1;
            selectImage();
        } else if (view.getId() == R.id.imgDoc2) {
            imgCounter = 2;
            selectImage();
    ...
    private void cameraIntent() {
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.M) {
            outputFileUri = FileProvider.getUriForFile(HoardingDetailActivity.this,
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == REQUEST_LOAD_IMAGE && data != null) {
                ...
                final Uri outputFileUri;
                if (Build.VERSION.SDK_INT > Build.VERSION_CODES.M) {
                    outputFileUri = FileProvider.getUriForFile(HoardingDetailActivity.this, BuildConfig.APPLICATION_ID + ".provider", croppedImageFile1);
                } else {
    ...
    public class getDetailTask extends AsyncTask<Void, String, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            jsonObject.addProperty("method", AppConstants.FEILDEXECUTATIVE.PROJECTSHOARDINGDETAILS);
            jsonObject.addProperty("user_id", AppPreference.getUserId(HoardingDetailActivity.this)); //8
            jsonObject.addProperty("project_id", project_id);
            jsonObject.addProperty("hoarding_id", hoarding_id);
            Log.e(TAG, "Request GET HOARDING DETAILS >> " + jsonObject);
            ...
            call.enqueue(new Callback<JsonObject>() {
                ...
                public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                    Log.e(TAG, "Response GET HOARDING DETAILS >> " + response.body().toString());
    ...
    public class updateDetailTask extends AsyncTask<Void, String, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            JsonObject jsonObject = new JsonObject();
            jsonObject.addProperty("method", AppConstants.FEILDEXECUTATIVE.SAVEHOARDINGDETAIL);
            jsonObject.addProperty("user_id", AppPreference.getUserId(HoardingDetailActivity.this)); //8
            jsonObject.addProperty("project_id", project_id);
        ...
        protected void onProgressUpdate(String... values) {
            ...
            String msg = values[1];
            if (status.equalsIgnoreCase("200")) {
                Intent intent = new Intent(HoardingDetailActivity.this, PerformHoardingActivity.class);
