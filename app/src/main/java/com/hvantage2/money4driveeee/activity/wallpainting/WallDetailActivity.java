...
public class WallDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setStateAdapter() {
        ...
        adapterState = new StateCityAdapter(WallDetailActivity.this, R.layout.state_city_item_layout, R.id.tvTitle, listState);
    ...
    private void setCityAdapter() {
        ...
        adapterCity = new StateCityAdapter(WallDetailActivity.this, R.layout.state_city_item_layout, R.id.tvTitle, listCity);
    ...
    private class GetStateTask extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... strings) {
            ...
            jsonObject.addProperty("project_id", AppPreference.getSelectedProjectId(WallDetailActivity.this));
