...
public class SelectWallPaintOptionActivity extends AppCompatActivity {

    private static final String TAG = "SelectWallPaintOption";
    ...
    private void setRecyclerView() {
        ...
        LinearLayoutManager manager = new LinearLayoutManager(SelectWallPaintOptionActivity.this);
        recycler_view.setLayoutManager(manager);
        adapter = new MediaAdapter(SelectWallPaintOptionActivity.this, list);
        recycler_view.setAdapter(adapter);
        recycler_view.addOnItemTouchListener(new RecyclerItemClickListener(SelectWallPaintOptionActivity.this, recycler_view, new RecyclerItemClickListener.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(SelectWallPaintOptionActivity.this, SelectWallActivity.class);
    ...
    public class GetData extends AsyncTask<Void, String, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            jsonObject.addProperty("user_id", AppPreference.getUserId(SelectWallPaintOptionActivity.this)); //8
            jsonObject.addProperty("project_id", AppPreference.getSelectedProjectId(SelectWallPaintOptionActivity.this));
            jsonObject.addProperty("branding_id", AppPreference.getSelectedAlloMediaId(SelectWallPaintOptionActivity.this));
            jsonObject.addProperty("media_type_id", media_type_id);
            Log.e(TAG, "Request WALL_PAINT MEDIA_OPTIONS >> " + jsonObject);
            ...
            call.enqueue(new Callback<JsonObject>() {
                ...
                public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                    Log.e(TAG, "Response WALL_PAINT MEDIA_OPTIONS >> " + response.body().toString());
        ...
        protected void onProgressUpdate(String... values) {
            ...
            if (status.equalsIgnoreCase("200")) {
                ...
                Toast.makeText(SelectWallPaintOptionActivity.this, msg, Toast.LENGTH_SHORT).show();
            }
        }
    }
